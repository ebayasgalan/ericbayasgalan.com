module.exports = [
  {
    ...
    title: "Easy Market",
    meta: "Ecommerce webapp",
    clientName: "Personal Project",
    category: "Ecommerce",
    projectDescriptions: (
      <>
        <p>
          Full stack ecommerce web app. Once authenticated, the user can post an item for sale or place an order and view it. 
          It's built with Nextjs v14, Typescript, Tailwind, Node.js, Prisma, Postgresql, Stripe, Next-Auth, and AWS-S3. 
        </p>
      </>
    ),
  },
  {
    ...
    projectDescriptions: (
      <>
        <p>
          Inherited legacy backend codebase of an ecommerce website and optimized it to handle high amounts of network traffic. 
          By implementing micro-services architecture, the system became scalable, available, fault-tolerant, and cost effective. 
          It was built with Node.js, Postgresql, Nginx, Docker, and deployed on AWS-EC2 compute instances. 
          It supports 0 - 10,000rps under 60ms with a 0% error rate.
        </p>
      </>
    ),
  },
